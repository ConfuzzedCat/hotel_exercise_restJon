...
class HotelControllerTest
{
    ...
    {
        Room r100 = new Room(100, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r101 = new Room(101, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r102 = new Room(102, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r103 = new Room(103, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r104 = new Room(104, new BigDecimal(3200), Room.RoomType.DOUBLE, 100);
        Room r105 = new Room(105, new BigDecimal(4500), Room.RoomType.SUITE, 150);
    ...
    {
        Room r111 = new Room(111, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r112 = new Room(112, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r113 = new Room(113, new BigDecimal(2520), Room.RoomType.SINGLE, 50);
        Room r114 = new Room(114, new BigDecimal(2520), Room.RoomType.DOUBLE, 100);
        Room r115 = new Room(115, new BigDecimal(3200), Room.RoomType.DOUBLE, 100);
        Room r116 = new Room(116, new BigDecimal(4500), Room.RoomType.SUITE, 150);
